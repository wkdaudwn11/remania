...
<script type="text/javascript">
	...
	function find(){
		location.replace('mobileFindPwdForEmail');
	}
...
<body>
	...
	<div class="carousel-inner" role="listbox">
		<div class="item active">
			<div class="carousel-caption1zz" style="height:32.4em; text-align: center; color: #FFFFFF; background-image: url('images/mobile/sample10.jpg');">
				<br /><br /><br /><br />
				
				<span style="color:#C5C5C5; font-size: 3em;">아이디 찾기</span>
				<p style="color:#C5C5C5; font-size: 0.8em;">
					<font color="white">아이디</font>를 찾기 위해선 <br />
					<font color="white">핸드폰</font> 인증을 해주셔야 합니다!
				</p>
				<br />
				
				<form id="findForm" method="post" action="findId">
					...
					<div style="background-color:#db6450; width: 20em; height: 3em; margin: 0 auto; border-radius: 3em;">
						<span style="width: 30%; height: 2em; float: left; font-size: 1.1em; padding-top: 7px;">Tel</span>
					...
					<div id="confirm"
						...
						<span
							style="width: 30%; height: 2em; float: left; font-size: 1.1em; padding-top: 7px;">인증번호</span>
				...
				<button type="button" class="btn btn-default"  id="checkNumber"
						...
						style="background-color: gray; color:white; width: 20em; border-radius: 3em; opacity: 0.8;">
					인증번호 받기
				</button> 
				
				<button type="button" class="btn btn-default"  id="sign"
						onclick="check2(findForm)"
						style="background-color: gray; color:white; width: 20em; border-radius: 3em; opacity: 0.8; display: none;">
					아이디 찾기
				</button> 
			</div>
		</div>
