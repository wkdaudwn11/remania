			...
			<ul class="nav navbar-nav navbar-right">
				...
				<c:choose>
					<c:when test="${empty login}">
						<li><a href="mobileLogin">Sign in</a></li>
						<li><a href="mobileJoin">Sign up</a></li>
						<li class="dropdown">
							<a class="dropdown-toggle" data-toggle="dropdown" href="#">
								Find<span class="caret"></span>
							</a>
							<ul class="dropdown-menu">
								<li><a href="mobileFindId"><font color="white">Find ID</font></a></li>
								<li><a href="mobileFindPwdForEmail"><font color="white">Find Password</font></a></li>
							</ul>
						</li>
					</c:when>
					<c:when test="${!empty login}">
				...
				<li class="dropdown">
					...
					<ul class="dropdown-menu">
						<li><a href="freeBoardList"><font color="white">Free</font></a></li>
						<li><a href="questionList"><font color="white">Question</font></a></li>
					</ul>
				</li>
