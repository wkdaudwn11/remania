	...
	<div class="carousel-inner" role="listbox">
		<div class="item active">
			<div class="carousel-caption1zz" style="height: 44.3em; text-align: center; color: #FFFFFF; background-image: url('images/test/sample5.jpg');">
				<br /><br /><br /><br /><br />
				<span style="color:#C5C5C5; font-size: 5em;">아이디 찾기</span>
				...
				<form id="findForm" method="post" action="findId">
					...
					<!-- confirm -->
					<div id="confirm" style="background-color: #478637; width: 30em; height: 3em; margin: 0 auto; border-radius: 3em; display: none;">
						<span style="width: 30%; height: 2em; float: left; font-size: 1.5em; padding-top: 7px;">
							인증번호
						</span>
				...
				<button type="button" class="btn btn-default"  id="sign" onclick="check2(findForm)"
